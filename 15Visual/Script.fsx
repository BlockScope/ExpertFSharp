...
let r = new Rectangle(Width=100.,Height=100.,RadiusX=5.,
                      RadiusY=5.,Stroke=Brushes.Black)
c.Children.Add(r)
...
let t = w.FindName("Input")
MessageBox.Show(sprint "Input value is %s " t.Text) |> ignore
t.Text <- "Hello"
MessageBox.Show(sprint "Input value now is %s " t.Text) |> ignore
